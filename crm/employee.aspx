...
<body>
  ...
  <asp:SqlDataSource ID="sds1" SelectCommand="SELECT [id_possition], [name_possition] FROM [CRMBase].[dbo].[possition_employee]" runat ="server"></asp:SqlDataSource>
  <asp:DropDownList ID="lstRole" runat="server" DataSourceID="sds1" DataTextField="name_possition" DataValueField="id_possition" CssClass="mr-sm-2" Width="280px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                </asp:DropDownList>             
                ...
                <asp:Label ID="lbltbBirthday" runat="server"
                    CssClass="font_style" Text="День рождения"></asp:Label>
                <br />

                <asp:TextBox ID="tbBirthday" runat ="server" style="margin-left: 0px" CssClass="text-center textbox" ></asp:TextBox>
                <br />
                ...
                <asp:Label ID="lblUnit2" runat="server"
                    CssClass="font_style" Text="Роль"></asp:Label>
                <br />
