<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="warning.aspx.cs" Inherits="crm.warning" %>
        ...
        <div style="overflow: unset">
            <div class="block-left block-2">
                ...
                <asp:Label ID="lbl1" runat="server"
                    Text="Задача" CssClass="font_style"></asp:Label>
                <asp:DropDownList ID="lstRole" runat="server"  CssClass="mr-sm-2" Width="280px">
                </asp:DropDownList>
                <br />
                <br />
                
                <asp:Label ID="lblQuantity" runat="server"
                    Text="Комментарий" CssClass="font_style"></asp:Label>
